...
# He answers 'Sure.' if you ask him a question. He answers 'Whatever.' if you tell him 
#something. He answers 'Woah, chill out!' if you yell at him (ALL CAPS). 
...
loop do 
    ...
    if question.include?("?")
        ...
        puts "Whatever"
    elsif (question == question.upcase) == true
        puts 'Woah, chill out!'
    elsif question == ""
...
# loop do 
#     question = gets.to_s
#     if question.start_with?("Bro")
#         if question.each_char.first("^aoiue")
#             question.each_char.first.lowercase
#         elsif question.include?("aeio")
